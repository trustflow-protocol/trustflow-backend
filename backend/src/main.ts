...
async function bootstrap() {
  ...
  // Strict CSP everywhere except the Swagger UI paths (see common/http/docs-security.ts).
  ...
  if (swaggerEnabled) {
    ...
    if (docsAuth) app.use(['/api/docs', '/api/docs-json'], docsAuth);
    ...
    logger.log('Swagger documentation enabled at /api/docs and /api/docs-json');
  } else {
